...
public class Panel_Settings : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        m_AusioEnabled = GameSettingsManager.Instance.isAudioEnabled;
        m_ShadowEnabled = GameSettingsManager.Instance.isShadowEnable;
    ...
    public void Button_Audio()
    {
        ...
        GameSettingsManager.Instance.isAudioEnabled = m_AusioEnabled;
    ...
    public void Button_Shadow()
    {
        ...
        GameSettingsManager.Instance.isShadowEnable = m_ShadowEnabled;
